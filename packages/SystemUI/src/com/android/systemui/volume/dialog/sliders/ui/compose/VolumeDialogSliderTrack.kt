...
fun SliderTrack(
    ...
    val isGradientActive = !ignoreGradient && gradientEnabled
    val gradient = if (rememberGradientColorMode(isGradientActive) == 1) {
            rememberGradientCustomColors(isGradientActive)
        } else {
            VolumeGradient(
...
@Composable
fun rememberGradientCustomColors(enabled: Boolean): VolumeGradient {
