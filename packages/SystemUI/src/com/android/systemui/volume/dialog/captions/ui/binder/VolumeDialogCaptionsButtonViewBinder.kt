...
constructor(
    ...
    override fun CoroutineScope.bind(view: View) {
        ...
        var gradientColorsForRinger = if (gradientEnabled) {
            getGradientColorsForRinger(captionsButton.context)
        } else {
            Pair(0, 0)
        }
        ...
        val gradientObserver =
            object : ContentObserver(null) {
                override fun onChange(selfChange: Boolean) {
                    ...
                    gradientColorsForRinger = if (gradientEnabled) {
                        getGradientColorsForRinger(view.context)
                    } else {
                        Pair(0, 0)
                    }
                }
    ...
    private fun getGradientColorsForRinger(context: Context): Pair<Int, Int> {
        return com.android.systemui.util.GradientColorUtils.getGradientColors(context)
    }
