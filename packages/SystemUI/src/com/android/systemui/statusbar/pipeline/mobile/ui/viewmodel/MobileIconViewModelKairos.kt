...
interface MobileIconViewModelKairosCommon {
    ...
    val smallMobileData: KairosState<Boolean>
}
...
class MobileIconViewModelKairos(
    ...
    override val smallMobileData: KairosState<Boolean> =
        vmProvider.flatMap { it.smallMobileData }
}
...
private class CarrierBasedSatelliteViewModelKairosImpl(
    ...
    override val smallMobileData: KairosState<Boolean> = stateOf(false)
}
...
private class CellularIconViewModelKairos(
    ...
    override val smallMobileData: KairosState<Boolean> = iconInteractor.smallMobileData
}
