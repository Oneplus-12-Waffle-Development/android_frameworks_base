...
interface MobileIconInteractorKairos {
    ...
    val smallMobileData: State<Boolean>
}
...
class MobileIconInteractorKairosImpl(
    ...
    private final val SMALL_MOBILE_DATA: String =
            "system:small_mobile_data"

    override val smallMobileData: State<Boolean> = buildState {
        callbackFlow {
                val callback =
                    object : TunerService.Tunable {
                        override fun onTuningChanged(key: String, newValue: String?) {
                ...
                Dependency.get(TunerService::class.java).addTunable(callback, SMALL_MOBILE_DATA)
