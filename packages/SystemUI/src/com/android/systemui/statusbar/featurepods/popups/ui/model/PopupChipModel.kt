...
sealed interface PopupContentModel {
    ...
    data class PromotedOngoing(val event: com.android.systemui.axdynamicbar.model.IslandEvent.PromotedOngoing) : PopupContentModel

    data class OngoingCall(val event: com.android.systemui.axdynamicbar.model.IslandEvent.Call) : PopupContentModel
}
