...
constructor(
    ...
    private val lockScreenMediaInfinityUri =
        secureSettings.getUriFor("infinity_bar_lockscreen_media_enabled")
        ...
        val settingsObserver: ContentObserver =
            object : ContentObserver(handler) {
                override fun onChange(selfChange: Boolean, uri: Uri?) {
                    if (uri == lockScreenMediaPlayerUri || uri == lockScreenMediaInfinityUri) {
                        val isInfinityBarMediaEnabled = secureSettings.getBoolForUser(
                            "infinity_bar_lockscreen_media_enabled",
                            false,
                            UserHandle.USER_CURRENT,
                        )
                        allowMediaPlayerOnLockScreen = !isInfinityBarMediaEnabled &&
